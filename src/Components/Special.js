            ...
            <div className="col-lg-9 mt-4 mt-lg-0" style={{ backgroundColor: "#fff6e8" }}>
              <div className="tab-content">
                <div className="tab-pane active show" id="tab-1">
                  <div className="row">
                    <div className="col-lg-8 details order-2 order-lg-1" >
                      ...
                      <div class="accordion accordion-flush" id="accordionExample" style={{ backgroundColor: "#fff7ec" }}>
                        <div class="accordion-item border border-success border-5  rounded-3">
                          <h2 class="accordion-header " id="headingOne">
                            <button class="accordion-button border border-success border-5  rounded-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        ...
                        <br />
                        <div class="accordion-item border border border-success border-5  rounded-3">
                          <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed border border-success border-5  rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <br />
                        <div class="accordion-item border border-success border border-success border-5  rounded-3">
                          <h2 class="accordion-header " id="headingThree">
                            <button class="accordion-button collapsed border border-success border-5  rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        ...
                        <div class="accordion-item border border-success border-5  rounded-3">
                          <h2 class="accordion-header" id="headingFour">
                            <button class="accordion-button collapsed border border-success border-5  rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                ...
                <div className="tab-pane" id="tab-2">
                  <div className="row">
                    <div className="col-lg-8 details order-2 order-lg-1">
                      <div class="accordion" id="accordionExample" style={{ backgroundColor: "#fff7ec" }}>
                        <div class="accordion-item border border-success border-5  rounded-3">
                          <h2 class="accordion-header " id="headingOne">
                            <button class="accordion-button border border-success border-5 collapsed rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      ...
                      <div class="accordion" id="accordionExample" style={{ backgroundColor: "#fff7ec" }}>
                        ...
                        <div class="accordion-item border border-success border border-success border-5  rounded-3">
                          <h2 class="accordion-header " id="headingFive">
                            <button class="accordion-button collapsed border border-success border-5  rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
