        ...
        <div className="container-fluid">
          ...
          <div className="row g-0">
            <div className="col-lg-3 col-md-4">
              ...
              <div className="gallery-item ">
                <a href="https://newgeniedc.iiita.ac.in/" target="_blank" className="gallery-lightbox">
            ...
            <div className="col-lg-3 col-md-4">
              ...
              <div className="gallery-item ">
                <a href="https://climatecollective.net/" target="_blank" className="gallery-lightbox">
